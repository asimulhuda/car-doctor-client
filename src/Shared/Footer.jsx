  ...
  return (
    <div className="">
      <footer className="relative w-full bg-[#151515] text-white">
        <div className="lg:max-w-[1140px] lg:mx-auto mx-5 py-16">
          <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
            <div className="flex flex-col lg:items-start items-center mb-6">
              <Link to="/">
                <img src={logo} alt="ExploreX" className="w-24 mb-4" />
              </Link>
              <p>
              ...
              {LINKS.map(({ title, items }) => (
                <ul key={title}>
                  <Typography
                    variant="small"
                    color="white"
                    className="mb-6 font-semi text-xl"
                  >
                    {title}
                  </Typography>
                  {items.map((link) => (
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-white-50 py-4 md:flex-row md:justify-between">
            ...
            >
              &copy; {currentYear}{" "}
              <a href="https://material-tailwind.com/">ExploreX</a>. Developed
              by{" "}
              <a
                target="_blank"
